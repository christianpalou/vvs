 ...
 */
  @Transactional
  public void follow(Long accountId, Long blogId)
      throws FollowException, InstanceNotFoundException {
 ...
 */
  @Transactional
  public void unfollow(Long accountId, Long blogId)
      throws FollowException, InstanceNotFoundException {
    Blog blog = blogRepository.findOne(blogId);
    Account account = accountRepository.findOne(accountId);
    if (blog == null) {
 ...
 */
  @Transactional
  public void acceptFollowRequest(Long accountId, Long blogId)
      throws FollowException, InstanceNotFoundException {
    Blog blog = blogRepository.findOne(blogId);
    Account account = accountRepository.findOne(accountId);
    if (blog == null) {
 ...
 */
  @Transactional
  public void denyFollowRequest(Long accountId, Long blogId)
      throws FollowException, InstanceNotFoundException {
    Blog blog = blogRepository.findOne(blogId);
    Account account = accountRepository.findOne(accountId);
    if (blog == null) {
